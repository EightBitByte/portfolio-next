  ...
  return (
    <div className="flex flex-col items-center gap-24">
      <HomeSection title="Me" gap={5}>
        ...
        <div className="flex flex-col gap-5 text-xl tracking-wideish leading-8">
      ...
      <HomeSection title="Projects" gap={6}>
        ...
        <ProjectButton
          ...
          shortDesc="Monitor friends' problem statuses and get live updates without leaving Discord."
          tags="Bot,Discord"
        />
        <ProjectButton
