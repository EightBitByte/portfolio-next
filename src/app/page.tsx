  ...
  return (
    <div className="grid grid-rows-1 w-full place-items-center gap-24">
      <HomeSection title="Me" gap={5}>
        <h1 className="text-3xl md:text-[2.35rem] font-bold">Hi, I'm Jacob Moy.</h1>
        <div className="flex flex-col gap-5 text-lg md:text-xl tracking-wideish leading-[22px] md:leading-7">
